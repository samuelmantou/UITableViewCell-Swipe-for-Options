#
#  Be sure to run `pod spec lint UITableViewCell-Swipe-for-Options.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of UITableViewCell-Swipe-for-Options in Markdown format.
  ...
  s.author       = { "samuelmantou" => "email@address.com" }
  # s.authors      = { "samuelmantou" => "email@address.com", "other author" => "email@address.com" }
  # s.author       = 'samuelmantou', 'other author'
  ...
  s.source_files  = 'TLSwipeForOptionsCell', 'TLSwipeForOptionsCell/**/*.{h,m}'
